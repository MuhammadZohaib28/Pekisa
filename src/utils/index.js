export const homeReviews = [
  {
    id: 1,
    review:
      "“We’ve been using Hover for twelve years for client sites. Hover’s customer service is the best we’ve experienced from any domain provider…We wouldn’t even consider using anyone else.”",
    name: "Gary Martin",
  ...
  },
  {
    id: 2,
    review:
      "“Hover makes it super easy to have all my domains in one place to quickly make changes and more, without the confusion and constant noise that others have.”",
    name: "Mike Hosier",
    designation: "Designer, MooseGoldens",
  },
  {
    id: 3,
    review:
    ...
    name: "Kirsty Cleverly",
    designation: "Bonjour Quilts",
  },
  {
    id: 4,
    review:
      "“As my site grows, I have switched servers to meet my users' needs. Hover allows me a way to keep my domain and emails in a central place, no mater where my server moves!”",
    name: "Josh Grisdale",
    designation: "Founder, Tabifolk",
  },
  {
    id: 5,
    review:
      "“Hover just works. If I ever have an issue, I know I can speak to a real person. I trust Hover.”",
    name: "Chuck Braverman",
    designation: "Co-founder & CEO, WestDoc Online",
  },
  {
    id: 6,
    review:
      "“We’ve been using Hover for twelve years for client sites. Hover’s customer service is the best we’ve experienced from any domain provider…We wouldn’t even consider using anyone else.”",
    name: "Kevin & Diane Hamilton",
    designation: "Binary Formations",
  },
  {
    id: 7,
    review:
      "“I’ve been using Hover for years. They’re always helpful and easy to contact. I’ve never had a problem with them.”",
    name: "Liz",
    designation: "Hover customer",
  },
];
